...
public class MajorScale {
    ...
    public static void main(String[] args) {
        MajorScale c_scale = new MajorScale("F");
    ...
    public MajorScale(Note scaleRoot){
        ...
        degree_3 = degree_2.sharp(2);
        degree_4 = degree_3.sharp(1);
        degree_5 = degree_4.sharp(2);
        degree_6 = degree_5.sharp(2);
    ...
    private MajorScale sharp(){
        MajorScale result = new MajorScale(this.root.sharp(1));
        return result;
    }
    public MajorScale sharp(int n){
        if(n >= 12) n = n % 12;
        MajorScale result = new MajorScale(this);
        for(int i = 1; i <=n; i++) result = result.sharp(1);
        return result;
    }
    private MajorScale flat(){
        MajorScale result = new MajorScale(this.root.flat(1));
        return result;
    }
