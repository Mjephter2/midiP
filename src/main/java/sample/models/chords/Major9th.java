...
/**
 * Class implementing a Major 9th Chord.
 */
public final class Major9th implements Chord {
    /**
     * max number of notes in any Major 9th Chord.
     */
    ...
    @Override
    public Major9th transposeUp(final int n) throws InvalidNoteException {
        return this.sharp(n);
    }
    @Override
    public Major9th transposeDown(final int n) throws InvalidNoteException {
        return this.flat(n);
    }
    @Override
    public Note[] notes() {
    ...
    /**
     * Constructs a Major 9th Chord rooted at the passed Note.
     * @param scaleRoot root of the Chord
     * @throws InvalidNoteException
     */
    public Major9th(final Note scaleRoot) throws InvalidNoteException {
        this(scaleRoot.getName());
    }

    /**
     * Default Constructor
     * Constructs a Major 9th Chord rooted at C3.
     * @throws InvalidNoteException
     */
    ...
    /**
     * Constructs a Major 9th Chord rooted at the same Note.
     * as the passed Chord
     * @param chord Note to copy root from
     * @throws InvalidNoteException
     */
    public Major9th(final Major9th chord) throws InvalidNoteException {
        this(chord.chordNotes[0].getName());
    }

    /**
     * Constructs a Major 9th Chord rooted at the Note described.
     * by the passed String
     * @param root name of the root Note
     * @throws InvalidNoteException
     */
    public Major9th(final String root) throws InvalidNoteException {
    ...
    private Major9th sharp(final int n) throws InvalidNoteException {
    ...
    private Major9th flat(final int n) throws InvalidNoteException {
        if (Utilities.NOTE_NAMES.indexOf(this.chordNotes[0].getName())
    ...
    public String toString() {
        ...
        rep.append(getRoot().noteQuality() + " Major 9 :");
